...
import SAGA.*;
import SAGA.Comparador.ComparadorPorData;
import SAGA.Comparador.ComparadorPorFornecedor;
import SAGA.Comparador.ComparadorPorNome;
import SAGA.Comparador.CriterioOrdenacao;
...
public class ControllerCliente {
    ...
    public String exibeCliente(String cpf) {
        this.validador.validaString(cpf, "Erro na exibicao do cliente: cpf nao pode ser vazio ou nulo.");
    ...
    public void editarCliente(String cpf, String opcao, String novoValor) {
        this.validador.validaString(cpf, "Erro na edicao do cliente: cpf nao pode ser vazio ou nulo.");
        this.validador.validaString(novoValor, "Erro na edicao do cliente: novo valor nao pode ser vazio ou nulo.");
        this.validador.validaString(opcao, "Erro na edicao do cliente: atributo nao pode ser vazio ou nulo.");
    ...
    public void removerCliente(String cpf) {
        this.validador.validaString(cpf,"Erro na remocao do cliente: cpf nao pode ser vazio ou nulo");
    ...
    public void cadastraCompra(String cpf, String fornecedor, String data, String nomeProduto, String descricaoProduto) {
        this.validador.validaString(cpf, "Erro ao cadastrar compra: cpf nao pode ser vazio ou nulo.");
    ...
    public String getDebito(String cpf, String fornecedor) {
        this.validador.validaString(cpf, "Erro ao recuperar debito: cpf nao pode ser vazio ou nulo.");
    ...
    public String getContaEmFornecedor(String cpf, String fornecedor) {
        this.validador.validaString(cpf, "Erro ao exibir conta do cliente: cpf nao pode ser vazio ou nulo.");
    ...
    public String contaCliente(String cpf) {
        this.validador.validaString(cpf, "Erro ao exibir contas do cliente: cpf nao pode ser vazio ou nulo.");
        if (!(cpf.length() == 11)){
    ...
    public void realizaPagamento(String cpf, String fornecedor) {
        this.validador.validaString(cpf, "Erro no pagamento de conta: cpf nao pode ser vazio ou nulo.");
        this.validador.validaString(fornecedor, "Erro no pagamento de conta: fornecedor nao pode ser vazio ou nulo.");
        this.validador.validaTamanho(cpf, 11, "Erro no pagamento de conta: cpf invalido.");
    ...
    /**
     * Metodo que define qual vai ser o criteiro de ordenacao no momento da exibicao de todas as compras do sistema
     * @param criterio criterio de ordenacao
     */
    public void ordenaPor(String criterio) {
        this.validador.validaString(criterio, "Erro na listagem de compras: criterio nao pode ser vazio ou nulo.");
    ...
    /**
     * Metodo que lista todas as compras do sistema, ordenando por cliente ou fornecedro ou data
     * @return todas as compras do sistema ordenadas
     */
